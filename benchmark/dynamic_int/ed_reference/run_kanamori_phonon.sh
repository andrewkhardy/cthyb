...
#
# These runs are short (minutes at beta=5); the allocation above is generous on purpose.

cd "${SLURM_SUBMIT_DIR:-$(dirname "$0")}" || exit 1
DATA=/mnt/home/ahardy/ceph/CTHYB_Data/ed_reference
mkdir -p ${DATA}

COMMON="--beta 10.0 --U 2.0 --J 0.3 --V 0.7 --omega_0 1.0 --n_cycles 1000000 --dyn_n_l 50 --out_dir ${DATA}"
...
srun -n 1 python ed_kanamori_phonon.py ${COMMON} --g 0.7 0.3
...
mpirun -n 96 python cthyb_kanamori_phonon.py ${COMMON} --g 0.7 0.3 --lang_firsov True
...
#srun -n 1 python ed_kanamori_phonon.py ${COMMON} --g 0.5 0.5
#mpirun -n 96 python cthyb_kanamori_phonon.py ${COMMON} --g 0.5 0.5 --lang_firsov True
...
#srun -n 1 python ed_kanamori_phonon.py ${COMMON} --g 0.5 0.0
#mpirun -n 96 python cthyb_kanamori_phonon.py ${COMMON} --g 0.5 0.0 --lang_firsov True
...
#mpirun -n 96 python cthyb_kanamori_phonon.py ${COMMON} --g 0.7 0.3 --lang_firsov False
...
# python plot_ed_vs_cthyb.py ${DATA}/ed_beta-5.0_U-2.0_J-0.3_V-0.7_eb-0.0_w0-1.0_g-0.7-0.3_mu-half_nph-24.h5 \
#                            ${DATA}/cthyb_beta-5.0_U-2.0_J-0.3_V-0.7_eb-0.0_w0-1.0_g-0.7-0.3_mu-half_lf-True_nc-1000000.h5
