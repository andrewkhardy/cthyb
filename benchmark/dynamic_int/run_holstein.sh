...
##################### run your code here #####################
#../CTHYB/benchmark/
mpirun -n 120 python spin_spin.py --lambda -0.1 --U 4.0  --beta 10.0 --n_cycles 1000000 --measure_O_tau 150
mpirun -n 120 python ctseg_spin_spin.py --lambda -0.1 --U 4.0   --beta 10.0 --n_cycles 1000000
