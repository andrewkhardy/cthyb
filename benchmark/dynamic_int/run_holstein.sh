...
##################### run your code here #####################
#../CTHYB/benchmark/
mpirun -n 120 python holstein.py --L 0.2 --U 4.0  --beta 20.0 --n_cycles 100000 --measure_O_tau 22 --dyn_n_l 100 --lang_firsov False
#mpirun -n 120 python ctseg_holstein.py --L 0.2 --U 4.0   --beta 10.0 --n_cycles 1100000
