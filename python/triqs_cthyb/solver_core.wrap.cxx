...
constexpr auto _c2py_doc_member_4 = R"DOC(Number of tau points for bosonic gf<imtime, matrix_valued> (for dynamical interactions))DOC";
constexpr auto _c2py_doc_member_5 = R"DOC(Number of Legendre polynomials.)DOC";
constexpr auto _c2py_doc_member_6 = R"DOC(Use :math:`\Delta(\tau)` and :math:`h_{loc0}` as input instead of :math:`G_0(i\omega)`.)DOC";
...
constinit PyGetSetDef c2py::tp_getset<_c2py_cls_0>[] = {
   ...
   c2py::getsetdef_from_member<&_c2py_cls_0::n_tau_bosonic, _c2py_cls_0>("n_tau_bosonic", _c2py_doc_member_4),
   c2py::getsetdef_from_member<&_c2py_cls_0::n_l, _c2py_cls_0>("n_l", _c2py_doc_member_5),
   c2py::getsetdef_from_member<&_c2py_cls_0::delta_interface, _c2py_cls_0>("delta_interface", _c2py_doc_member_6),
...
constexpr auto _c2py_doc_member_7  = R"DOC(Interacting part of the atomic Hamiltonian.)DOC";
constexpr auto _c2py_doc_member_8  = R"DOC(Number of QMC cycles.)DOC";
constexpr auto _c2py_doc_member_9  = R"DOC(Partition method.)DOC";
constexpr auto _c2py_doc_member_10 = R"DOC(Quantum numbers.)DOC";
constexpr auto _c2py_doc_member_11 = R"DOC(Restrict local Hilbert space to states with at least this number of particles.)DOC";
constexpr auto _c2py_doc_member_12 = R"DOC(Restrict local Hilbert space to states with at most this number of particles.)DOC";
...
constexpr auto _c2py_doc_member_34 = R"DOC(Measure :math:`G^{(2)}(i\omega,i\nu,i\nu')` in the particle-hole channel.)DOC";
constexpr auto _c2py_doc_member_35 = R"DOC(Measure :math:`G^{(2)}(i\omega,i\nu,i\nu')` in the particle-hole channel.)DOC";
constexpr auto _c2py_doc_member_36 = R"DOC(Measure :math:`G^{(2)}(i\omega,l,l')` in the particle-particle channel.)DOC";
constexpr auto _c2py_doc_member_37 = R"DOC(Measure :math:`G^{(2)}(i\omega,l,l')` in the particle-hole channel.)DOC";
constexpr auto _c2py_doc_member_38 = R"DOC(Order of block indices in the definition of :math:`G^{(2)}`.)DOC";
constexpr auto _c2py_doc_member_39 = R"DOC(List of block index pairs of :math:`G^{(2)}` to measure.)DOC";
constexpr auto _c2py_doc_member_40 = R"DOC(Number of imaginary-time slices for the :math:`G^{(2)}` measurement.)DOC";
constexpr auto _c2py_doc_member_41 = R"DOC(Number of bosonic Matsubara frequencies for the :math:`G^{(2)}` measurement.)DOC";
constexpr auto _c2py_doc_member_42 = R"DOC(Number of fermionic Matsubara frequencies for the :math:`G^{(2)}` measurement.)DOC";
constexpr auto _c2py_doc_member_43 = R"DOC(Number of Legendre coefficients for the :math:`G^{(2)}(i\omega,l,l')` measurement.)DOC";
constexpr auto _c2py_doc_member_44 = R"DOC(NFFT buffer size for the :math:`G^{(2)}(i\omega,l,l')` measurement.)DOC";
constexpr auto _c2py_doc_member_45 = R"DOC(NFFT buffer sizes for different blocks.)DOC";
constexpr auto _c2py_doc_member_46 = R"DOC(Measure perturbation order?)DOC";
constexpr auto _c2py_doc_member_47 = R"DOC(Measure the reduced impurity density matrix?)DOC";
constexpr auto _c2py_doc_member_48 = R"DOC(Use the norm of the density matrix in the weight (instead of the trace)?)DOC";
constexpr auto _c2py_doc_member_49 = R"DOC(Initial configuration of the run (advanced, use with care).)DOC";
constexpr auto _c2py_doc_member_50 = R"DOC(Analyse performance of the trace computation with histograms (developers only)?)DOC";
constexpr auto _c2py_doc_member_51 = R"DOC(Operator insertion/removal probabilities for different blocks.)DOC";
...
constexpr auto _c2py_doc_member_53 = R"DOC(Overall probability of the global moves.)DOC";
constexpr auto _c2py_doc_member_54 = R"DOC(Threshold below which imaginary components of :math:`\Delta` and :math:`h_{loc}` are set to zero.)DOC";
constexpr auto _c2py_doc_member_55 = R"DOC(The maximum size of the determinant matrix before a resize.)DOC";
constexpr auto _c2py_doc_member_56 = R"DOC(Maximum number of operations before testing the accuracy of :math:`\det(M)` and :math:`M^{-1}`.)DOC";
constexpr auto _c2py_doc_member_57 = R"DOC(Threshold for determinant precision warnings.)DOC";
constexpr auto _c2py_doc_member_58 = R"DOC(Threshold for determinant precision error.)DOC";
constexpr auto _c2py_doc_member_59 = R"DOC(Bound for the determinant matrix being singular (if :math:`< 0`, checks for subnormal numbers).)DOC";
constexpr auto _c2py_doc_member_60 = R"DOC(Threshold below which off-diagonal components of :math:`h_{loc}` are set to zero.)DOC";
constexpr auto _c2py_doc_member_61 = R"DOC(Quadratic part of the local Hamiltonian. Must be provided if the :math:`\Delta` interface is used.)DOC";
...
constinit PyGetSetDef c2py::tp_getset<_c2py_cls_1>[] = {
   c2py::getsetdef_from_member<&_c2py_cls_1::h_int, _c2py_cls_1>("h_int", _c2py_doc_member_7),
   c2py::getsetdef_from_member<&_c2py_cls_1::n_cycles, _c2py_cls_1>("n_cycles", _c2py_doc_member_8),
   c2py::getsetdef_from_member<&_c2py_cls_1::partition_method, _c2py_cls_1>("partition_method", _c2py_doc_member_9),
   c2py::getsetdef_from_member<&_c2py_cls_1::quantum_numbers, _c2py_cls_1>("quantum_numbers", _c2py_doc_member_10),
   c2py::getsetdef_from_member<&_c2py_cls_1::loc_n_min, _c2py_cls_1>("loc_n_min", _c2py_doc_member_11),
   c2py::getsetdef_from_member<&_c2py_cls_1::loc_n_max, _c2py_cls_1>("loc_n_max", _c2py_doc_member_12),
   ...
   c2py::getsetdef_from_member<&_c2py_cls_1::move_shift, _c2py_cls_1>("move_shift", _c2py_doc_member_19),
   c2py::getsetdef_from_member<&_c2py_cls_1::move_double, _c2py_cls_1>("move_double", _c2py_doc_member_20),
   c2py::getsetdef_from_member<&_c2py_cls_1::use_trace_estimator, _c2py_cls_1>("use_trace_estimator", _c2py_doc_member_21),
   c2py::getsetdef_from_member<&_c2py_cls_1::lang_firsov, _c2py_cls_1>("lang_firsov", _c2py_doc_member_22),
   c2py::getsetdef_from_member<&_c2py_cls_1::dyn_n_l, _c2py_cls_1>("dyn_n_l", _c2py_doc_member_23),
   c2py::getsetdef_from_member<&_c2py_cls_1::measure_G_tau, _c2py_cls_1>("measure_G_tau", _c2py_doc_member_24),
   c2py::getsetdef_from_member<&_c2py_cls_1::measure_G_l, _c2py_cls_1>("measure_G_l", _c2py_doc_member_25),
   c2py::getsetdef_from_member<&_c2py_cls_1::measure_O_tau, _c2py_cls_1>("measure_O_tau", _c2py_doc_member_26),
   c2py::getsetdef_from_member<&_c2py_cls_1::measure_O_tau_min_ins, _c2py_cls_1>("measure_O_tau_min_ins", _c2py_doc_member_27),
   c2py::getsetdef_from_member<&_c2py_cls_1::measure_D0_corr, _c2py_cls_1>("measure_D0_corr", _c2py_doc_member_28),
   c2py::getsetdef_from_member<&_c2py_cls_1::measure_G2_tau, _c2py_cls_1>("measure_G2_tau", _c2py_doc_member_29),
   c2py::getsetdef_from_member<&_c2py_cls_1::measure_G2_iw, _c2py_cls_1>("measure_G2_iw", _c2py_doc_member_30),
   c2py::getsetdef_from_member<&_c2py_cls_1::measure_G2_iw_nfft, _c2py_cls_1>("measure_G2_iw_nfft", _c2py_doc_member_31),
   c2py::getsetdef_from_member<&_c2py_cls_1::measure_G2_iw_pp, _c2py_cls_1>("measure_G2_iw_pp", _c2py_doc_member_32),
   c2py::getsetdef_from_member<&_c2py_cls_1::measure_G2_iw_pp_nfft, _c2py_cls_1>("measure_G2_iw_pp_nfft", _c2py_doc_member_33),
   c2py::getsetdef_from_member<&_c2py_cls_1::measure_G2_iw_ph, _c2py_cls_1>("measure_G2_iw_ph", _c2py_doc_member_34),
   c2py::getsetdef_from_member<&_c2py_cls_1::measure_G2_iw_ph_nfft, _c2py_cls_1>("measure_G2_iw_ph_nfft", _c2py_doc_member_35),
   c2py::getsetdef_from_member<&_c2py_cls_1::measure_G2_iwll_pp, _c2py_cls_1>("measure_G2_iwll_pp", _c2py_doc_member_36),
   c2py::getsetdef_from_member<&_c2py_cls_1::measure_G2_iwll_ph, _c2py_cls_1>("measure_G2_iwll_ph", _c2py_doc_member_37),
   c2py::getsetdef_from_member<&_c2py_cls_1::measure_G2_block_order, _c2py_cls_1>("measure_G2_block_order", _c2py_doc_member_38),
   c2py::getsetdef_from_member<&_c2py_cls_1::measure_G2_blocks, _c2py_cls_1>("measure_G2_blocks", _c2py_doc_member_39),
   c2py::getsetdef_from_member<&_c2py_cls_1::measure_G2_n_tau, _c2py_cls_1>("measure_G2_n_tau", _c2py_doc_member_40),
   c2py::getsetdef_from_member<&_c2py_cls_1::measure_G2_n_bosonic, _c2py_cls_1>("measure_G2_n_bosonic", _c2py_doc_member_41),
   c2py::getsetdef_from_member<&_c2py_cls_1::measure_G2_n_fermionic, _c2py_cls_1>("measure_G2_n_fermionic", _c2py_doc_member_42),
   c2py::getsetdef_from_member<&_c2py_cls_1::measure_G2_n_l, _c2py_cls_1>("measure_G2_n_l", _c2py_doc_member_43),
   c2py::getsetdef_from_member<&_c2py_cls_1::measure_G2_iwll_nfft_buf_size, _c2py_cls_1>("measure_G2_iwll_nfft_buf_size", _c2py_doc_member_44),
   c2py::getsetdef_from_member<&_c2py_cls_1::nfft_buf_sizes, _c2py_cls_1>("nfft_buf_sizes", _c2py_doc_member_45),
   c2py::getsetdef_from_member<&_c2py_cls_1::measure_pert_order, _c2py_cls_1>("measure_pert_order", _c2py_doc_member_46),
   c2py::getsetdef_from_member<&_c2py_cls_1::measure_density_matrix, _c2py_cls_1>("measure_density_matrix", _c2py_doc_member_47),
   c2py::getsetdef_from_member<&_c2py_cls_1::use_norm_as_weight, _c2py_cls_1>("use_norm_as_weight", _c2py_doc_member_48),
   c2py::getsetdef_from_member<&_c2py_cls_1::initial_configuration, _c2py_cls_1>("initial_configuration", _c2py_doc_member_49),
   c2py::getsetdef_from_member<&_c2py_cls_1::performance_analysis, _c2py_cls_1>("performance_analysis", _c2py_doc_member_50),
   c2py::getsetdef_from_member<&_c2py_cls_1::proposal_prob, _c2py_cls_1>("proposal_prob", _c2py_doc_member_51),
   c2py::getsetdef_from_member<&_c2py_cls_1::move_global, _c2py_cls_1>("move_global", _c2py_doc_member_52),
   c2py::getsetdef_from_member<&_c2py_cls_1::move_global_prob, _c2py_cls_1>("move_global_prob", _c2py_doc_member_53),
   c2py::getsetdef_from_member<&_c2py_cls_1::imag_threshold, _c2py_cls_1>("imag_threshold", _c2py_doc_member_54),
   c2py::getsetdef_from_member<&_c2py_cls_1::det_init_size, _c2py_cls_1>("det_init_size", _c2py_doc_member_55),
   c2py::getsetdef_from_member<&_c2py_cls_1::det_n_operations_before_check, _c2py_cls_1>("det_n_operations_before_check", _c2py_doc_member_56),
   c2py::getsetdef_from_member<&_c2py_cls_1::det_precision_warning, _c2py_cls_1>("det_precision_warning", _c2py_doc_member_57),
   c2py::getsetdef_from_member<&_c2py_cls_1::det_precision_error, _c2py_cls_1>("det_precision_error", _c2py_doc_member_58),
   c2py::getsetdef_from_member<&_c2py_cls_1::det_singular_threshold, _c2py_cls_1>("det_singular_threshold", _c2py_doc_member_59),
   c2py::getsetdef_from_member<&_c2py_cls_1::off_diag_threshold, _c2py_cls_1>("off_diag_threshold", _c2py_doc_member_60),
   c2py::getsetdef_from_member<&_c2py_cls_1::h_loc0, _c2py_cls_1>("h_loc0", _c2py_doc_member_61),
...
constexpr auto _c2py_doc_member_65 = R"DOC(Single-particle Green's function :math:`G(\tau)` in imaginary time.)DOC";
constexpr auto _c2py_doc_member_66 = R"DOC(Intermediate Green's function used to accumulate :math:`G(\tau)` (real or complex).)DOC";
constexpr auto _c2py_doc_member_67 = R"DOC(Violation of the property :math:`G_{ij}(\tau) = G_{ji}^*(\tau)` after the measurement.)DOC";
constexpr auto _c2py_doc_member_68 = R"DOC(Single-particle Green's function :math:`G_l` in the Legendre representation.)DOC";
constexpr auto _c2py_doc_member_69 = R"DOC(General operator Green's function :math:`O(\tau)` in imaginary time.)DOC";
constexpr auto _c2py_doc_member_70 = R"DOC(Density-density correlator :math:`Q() =  n() n(0) ` in imaginary time.)DOC";
constexpr auto _c2py_doc_member_71 = R"DOC(Density-density correlator in Legendre representation.)DOC";
constexpr auto _c2py_doc_member_72 = R"DOC(Two-particle Green's function :math:`G^{(2)}(\tau_1,\tau_2,\tau_3)` with three fermionic times.)DOC";
constexpr auto _c2py_doc_member_73 = R"DOC(Two-particle Green's function :math:`G^{(2)}(i\nu,i\nu',i\nu'')` with three fermionic frequencies.)DOC";
constexpr auto _c2py_doc_member_74 = R"DOC(Two-particle Green's function :math:`G^{(2)}(i\nu,i\nu',i\nu'')` with three fermionic frequencies.)DOC";
constexpr auto _c2py_doc_member_75 = R"DOC(Two-particle Green's function :math:`G^{(2)}(i\omega,i\nu,i\nu')` in the particle-particle channel.)DOC";
constexpr auto _c2py_doc_member_76 = R"DOC(Two-particle Green's function :math:`G^{(2)}(i\omega,i\nu,i\nu')` in the particle-particle channel.)DOC";
...
constexpr auto _c2py_doc_member_79 = R"DOC(Two-particle Green's function :math:`G^{(2)}(i\omega,l,l')` in the particle-particle channel.)DOC";
constexpr auto _c2py_doc_member_80 = R"DOC(Two-particle Green's function :math:`G^{(2)}(i\omega,l,l')` in the particle-hole channel.)DOC";
constexpr auto _c2py_doc_member_81 = R"DOC(Histogram of the total perturbation order.)DOC";
constexpr auto _c2py_doc_member_82 = R"DOC(Histograms of the perturbation order for each block.)DOC";
constexpr auto _c2py_doc_member_83 = R"DOC(Histogram of the perturbation order in dynamical interactions)DOC";
...
static constexpr auto prop_doc_8 = R"DOC(Monte Carlo average sign.)DOC";
...
constinit PyGetSetDef c2py::tp_getset<_c2py_cls_2>[] = {
   ...
   c2py::getsetdef_from_member<&_c2py_cls_2::G_tau, _c2py_cls_2>("G_tau", _c2py_doc_member_65),
   c2py::getsetdef_from_member<&_c2py_cls_2::G_tau_accum, _c2py_cls_2>("G_tau_accum", _c2py_doc_member_66),
   c2py::getsetdef_from_member<&_c2py_cls_2::asymmetry_G_tau, _c2py_cls_2>("asymmetry_G_tau", _c2py_doc_member_67),
   c2py::getsetdef_from_member<&_c2py_cls_2::G_l, _c2py_cls_2>("G_l", _c2py_doc_member_68),
   c2py::getsetdef_from_member<&_c2py_cls_2::O_tau, _c2py_cls_2>("O_tau", _c2py_doc_member_69),
   c2py::getsetdef_from_member<&_c2py_cls_2::Q_tau, _c2py_cls_2>("Q_tau", _c2py_doc_member_70),
   c2py::getsetdef_from_member<&_c2py_cls_2::Q_l, _c2py_cls_2>("Q_l", _c2py_doc_member_71),
   c2py::getsetdef_from_member<&_c2py_cls_2::G2_tau, _c2py_cls_2>("G2_tau", _c2py_doc_member_72),
   c2py::getsetdef_from_member<&_c2py_cls_2::G2_iw, _c2py_cls_2>("G2_iw", _c2py_doc_member_73),
   c2py::getsetdef_from_member<&_c2py_cls_2::G2_iw_nfft, _c2py_cls_2>("G2_iw_nfft", _c2py_doc_member_74),
   c2py::getsetdef_from_member<&_c2py_cls_2::G2_iw_pp, _c2py_cls_2>("G2_iw_pp", _c2py_doc_member_75),
   c2py::getsetdef_from_member<&_c2py_cls_2::G2_iw_pp_nfft, _c2py_cls_2>("G2_iw_pp_nfft", _c2py_doc_member_76),
   c2py::getsetdef_from_member<&_c2py_cls_2::G2_iw_ph, _c2py_cls_2>("G2_iw_ph", _c2py_doc_member_77),
   c2py::getsetdef_from_member<&_c2py_cls_2::G2_iw_ph_nfft, _c2py_cls_2>("G2_iw_ph_nfft", _c2py_doc_member_78),
   c2py::getsetdef_from_member<&_c2py_cls_2::G2_iwll_pp, _c2py_cls_2>("G2_iwll_pp", _c2py_doc_member_79),
   c2py::getsetdef_from_member<&_c2py_cls_2::G2_iwll_ph, _c2py_cls_2>("G2_iwll_ph", _c2py_doc_member_80),
   c2py::getsetdef_from_member<&_c2py_cls_2::perturbation_order_total, _c2py_cls_2>("perturbation_order_total", _c2py_doc_member_81),
   c2py::getsetdef_from_member<&_c2py_cls_2::perturbation_order, _c2py_cls_2>("perturbation_order", _c2py_doc_member_82),
   c2py::getsetdef_from_member<&_c2py_cls_2::perturbation_order_dyn, _c2py_cls_2>("perturbation_order_dyn", _c2py_doc_member_83),
   ...
   {"G0_iw", c2py::getter_from_method<c2py::castm<>(&triqs_cthyb::solver_core::G0_iw)>, nullptr, prop_doc_3, nullptr},
   {"Jperp_tau", c2py::getter_from_method<c2py::castm<>(&triqs_cthyb::solver_core::Jperp_tau)>, nullptr, prop_doc_4, nullptr},
   {"auto_corr_time", c2py::getter_from_method<c2py::castmc<>(&triqs_cthyb::solver_core::auto_corr_time)>, nullptr, prop_doc_5, nullptr},
   {"auto_corr_time_converged", c2py::getter_from_method<c2py::castmc<>(&triqs_cthyb::solver_core::auto_corr_time_converged)>, nullptr, prop_doc_6,
    nullptr},
   {"average_order", c2py::getter_from_method<c2py::castmc<>(&triqs_cthyb::solver_core::average_order)>, nullptr, prop_doc_7, nullptr},
   {"average_sign", c2py::getter_from_method<c2py::castmc<>(&triqs_cthyb::solver_core::average_sign)>, nullptr, prop_doc_8, nullptr},
